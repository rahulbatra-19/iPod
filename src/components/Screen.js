        ...
        {isLeftVisible ? (
          ...
          <div className="full">
            ...
            {onscreen === "Games" && (
              <div className="full-func">
                <img
                  src="https://toppng.com/uploads/preview/dice-115628871397usecbjyyw.png"
                  alt="games"
                ></img>
                <p>Games</p>
              </div>
            ...
            {onscreen === "Settings" && (
              <div className="full-func">
                <img
                  src="https://e7.pngegg.com/pngimages/516/751/png-clipart-computer-icons-setting-windows-настройки.png"
                  alt="Settings"
                ></img>
                <p>Settings</p>
              </div>
